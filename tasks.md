...
- [x] 6. Snapshot naming utilities (`src/snapshot.rs`)
- [x] 7. Full backup (`src/backup/full.rs`)
- [x] 8. Incremental backup (`src/backup/incremental.rs`)
- [x] 9. S3 upload (`src/backup/s3.rs`)
